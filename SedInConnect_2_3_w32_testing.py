...
Improvements in respect to v 2.2 : Implemented Weighting factor normalization as in Trevisani e Cavalli, 2016
###############################################################################
"""
#
#
...
import threading
lib_path=os.path.abspath('C:\Users\stefano\Documents\GitHub\SedInConnect\SedInConnect_2.2')
...
import base64
import scipy.signal
#from from scipy.special import ufunc #this for dependencies, otherwise pyinstaller does not find _ufuncs_cxx trying to create scipy dll
...
class Connectivity_gui(QtGui.QMainWindow):
    ...
    def initUI(self):
        ...
        self.btn12.setGeometry(QtCore.QRect(640, 420, 85, 31))
        self.btn12.move(640, 420)
        ...
        self.btn6.setGeometry(QtCore.QRect(700, 420, 85, 31))
        self.btn6.move(735, 420)
